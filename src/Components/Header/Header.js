        ...
        <>
            <div className="container">
                <nav className="navbar navbar-expand-lg">
                    <a className="navbar-brand logo" href="#navbarNav"><img src={logo2} alt="" /></a>
                    ...
                    <div className="collapse navbar-collapse menu" id="navbarNav">
                        <ul className="navbar-nav justify-content-end">
                            <li className="nav-item">
                                <a className="nav-link" href="#navbarNav"><span className="icon">0</span> <FontAwesomeIcon className="icon2" icon={faShoppingCart} /></a>
                            </li>
                            <li className="nav-item">
                                <a className="nav-link" href="#navbarNav">Log in</a>
                            </li>
                            <li className="nav-item active">
                                <a className="nav-link" href="#navbarNav">Sign Up<span className="sr-only">(current)</span></a>
                            </li>
                        </ul>
                    </div>
                </nav>
